  window.onload = function()
{
  ...
  ply1span.style.marginTop ='-3%';
  ply1span2.style.position='absolute';
  ply1span2.style.marginLeft ='19%';
  ply1span2.style.marginTop ='-3%';
  var ply1h1 = document.createElement('h3');
  var ply1h2 = document.createElement('h3');
  ...
  // function that builds a deck of cards
    ...
    var makeCard = function(cardval)
    {
        ...
        var club = "url('http://www.massivemagazine.org.nz/wp-content/uploads/2014/03/clubs...png')";
        var heart = "url('http://www.clker.com/cliparts/8/f/f/a/119498481648610229card_figures_-_heart_01.svg.hi.png')";
        var diamond = "url('http://static.tumblr.com/76d04daa60a9ef84d9692c4a3e129f95/kbx8bze/LTEmw15gr/tumblr_static_diamond-cards-hi.png')";
        var spade = "url('http://www.iconattitude.com/icons/open_icon_library/symbols/png/256/cards-spade.png')";
        var shade;
        var pic;
        var number;
       ...
       // var cardval = '10C';
        ...
        cover.style.backgroundImage='url("http://chetart.com/blog/wp-content/uploads/2012/05/playing-card-back.jpg")';
